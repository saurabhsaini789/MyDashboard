    ...
    <main className="min-h-screen bg-[#fcfcfc] text-zinc-900 selection:bg-teal-500/10 p-6 md:p-10 lg:p-12 relative overflow-hidden">
      <div className="mx-auto w-full max-w-7xl flex flex-col gap-8 md:gap-10 pt-4 relative z-10">
        ...
        <div className="flex flex-col gap-6 items-center">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-zinc-900 text-center uppercase tracking-[0.3em] drop-shadow-sm leading-tight">
            Pantry
          </h1>
          <p className="text-sm text-zinc-500 uppercase tracking-widest text-center max-w-lg">
