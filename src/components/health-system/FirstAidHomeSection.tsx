...
export function FirstAidHomeSection({ externalFilter }: FirstAidHomeSectionProps) {
 ...
 console.error("Failed to parse first aid home data", e);
 }
 }
 ...
 */
 ...
 let suggestion = null;
 if (expiredCount > 0) {
 suggestion = "Home first aid kit needs attention — expired items found";
 } else if (missingCount > 0) {
 suggestion = "Restock home first aid essentials";
 } else if (lowCount > 0) {
 suggestion = "Refill low first aid supplies";
 }
