...
const STORAGE_KEY = SYNC_KEYS.HEALTH_TRAVEL_KIT;
 ...
 */
 ...
 const base = "text-[11px] font-semibold uppercase px-2 py-1 rounded-md inline-block";
 switch (status) {
 case 'OK': 
 ...
 <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 px-2">
  ...
  <div className="flex items-center gap-1.5 sm:gap-3">
    ...
    <select 
      ...
      className="bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-white text-[10px] sm:text-xs font-semibold px-2 sm:px-4 h-[54px] rounded-2xl border-none focus:ring-2 focus:ring-zinc-500 appearance-none cursor-pointer min-w-[100px] sm:min-w-[140px] flex-1 sm:flex-none"
    >
    ...
    <button 
      ...
      className="bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 text-xs font-semibold px-3 sm:px-8 py-4 rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-sm shadow-zinc-900/10 h-[54px] whitespace-nowrap"
    >
       ...
       <table className="w-full text-left border-collapse">
         <thead className="bg-zinc-50 dark:bg-zinc-800">
           <tr className="border-b border-zinc-100 dark:border-zinc-800">
             <th className="px-6 py-4 text-[11px] uppercase text-zinc-500 font-semibold">Status</th>
             <th className="px-6 py-4 text-[11px] uppercase text-zinc-500 font-semibold">Item Name</th>
             <th className="px-6 py-4 text-[11px] uppercase text-zinc-500 font-semibold">Category</th>
             <th className="px-6 py-4 text-[11px] uppercase text-zinc-500 font-semibold">Purpose / Use</th>
             <th className="px-6 py-4 text-[11px] uppercase text-zinc-500 font-semibold">When to Use</th>
             <th className="px-6 py-4 text-[11px] uppercase text-zinc-500 font-semibold text-center">Quantity</th>
             <th className="px-6 py-4 text-[11px] uppercase text-zinc-500 font-semibold">Expiry</th>
           </tr>
         </thead>
         <tbody>
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex flex-col">
                  <span className="text-[11px] font-semibold text-zinc-400 uppercase">Purpose</span>
                  <span className="text-xs text-zinc-700 dark:text-zinc-300 line-clamp-2">{item.purpose}</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-[11px] font-semibold text-zinc-400 uppercase">When to use</span>
