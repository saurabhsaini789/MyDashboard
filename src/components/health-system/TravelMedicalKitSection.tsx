 ...
 <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 px-2">
  ...
  <div className="flex items-center gap-3">
    ...
    <select 
      ...
      className="bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-white text-xs font-semibold px-4 h-[54px] rounded-2xl border-none focus:ring-2 focus:ring-zinc-500 appearance-none cursor-pointer min-w-[140px]"
    >
    ...
    <button 
      ...
      className="bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 text-xs font-semibold px-8 py-4 rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-sm shadow-zinc-900/10 h-[54px]"
    >
      ADD MEDICINE
    </button>
  </div>
