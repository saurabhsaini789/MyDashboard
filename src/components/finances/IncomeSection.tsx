...
export function IncomeSection() {
 ...
 className="bg-emerald-600 text-white text-xs px-8 py-4 rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-emerald-200/50 dark:shadow-none h-[54px]"
 >
 Add Record
 </button>
 </div>
 ...
 <Text variant="label" as="th" className="px-4 py-4 font-semibold uppercase">Source</Text>
 <Text variant="label" as="th" className="px-4 py-4 font-semibold uppercase">Type</Text>
 <Text variant="label" as="th" className="px-4 py-4 font-semibold uppercase">Account</Text>
 ...
 <td className="px-4 py-5">
 <Text variant="body" as="span" className="uppercase font-semibold">
 {record.source === 'other' && record.customSource ? `Other (${record.customSource})` : record.source}
 </Text>
 </td>
 <td className="px-4 py-5">
 <Text variant="label" as="span" className="px-2.5 py-1 rounded-lg border bg-emerald-50 text-emerald-600 border-emerald-100 dark:bg-emerald-500/10 dark:text-emerald-400">
 {record.type}
 </Text>
 </td>
 <td className="px-4 py-5">
 <Text variant="body" as="span" className="text-zinc-500 dark:text-zinc-300">
 ...
 <span className="text-xs text-zinc-500 dark:text-zinc-300 uppercase">No income recorded for this period</span>
 </td>
 </tr>
 )}
 </tbody>
