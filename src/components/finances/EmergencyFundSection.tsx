...
export function EmergencyFundSection() {
 ...
 <div className="w-10 h-10 rounded-2xl bg-amber-50 dark:bg-amber-500/10 flex items-center justify-center text-amber-600 dark:text-amber-400 font-semibold">$</div>
 <div className="flex flex-col">
 <span className="text-lg font-bold text-zinc-900 dark:text-zinc-100">
 ${(c.amount || 0).toLocaleString('en-CA', { maximumFractionDigits: 0 })}
 </span>
 <span className="text-xs text-zinc-500 uppercase font-medium">{new Date(c.date).toLocaleDateString('en-CA', { month: 'long', day: 'numeric', year: 'numeric' })}</span>
 </div>
 </div>
