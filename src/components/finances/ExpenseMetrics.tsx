...
function MetricCard({ label, value, subValue, icon, color }: MetricProps) {
 ...
 return (
 <div className="flex flex-col p-6 rounded-2xl border border-l-4 border-rose-100 dark:border-rose-900/30 bg-white dark:bg-zinc-900/60 shadow-sm transition-all group relative overflow-hidden h-full">
 ...
 <span className="text-xs uppercase text-zinc-600 dark:text-zinc-400 bg-zinc-50 dark:bg-zinc-800/50 px-3 py-1.5 rounded-xl font-semibold">
 {subValue}
 </span>
 </div>
 )}
