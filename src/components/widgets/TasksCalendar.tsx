...
export function TasksCalendar() {
 ...
 <Text key={`${day}-${idx}`} variant="label" className="text-center font-semibold py-1">
 {day}
 </Text>
 ))}
 </div>
 ...
 className={`border rounded-lg p-1 relative flex flex-col items-center justify-center h-8 md:h-10 lg:h-11 transition-all ${isSelected ? 'border-indigo-500 bg-indigo-500 text-white shadow-md shadow-indigo-500/20' : isToday ? 'border-indigo-400/50 bg-indigo-50/50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400' : 'border-zinc-200/50 dark:border-zinc-800/50 bg-zinc-50/50 dark:bg-zinc-900/30 text-zinc-700 dark:text-zinc-300 hover:border-indigo-300 hover:bg-zinc-100 dark:hover:bg-zinc-800/50' }`}
 >
 <Text variant="label" className={isSelected ? 'text-white font-semibold' : 'font-semibold'}>
 {day}
 </Text>
 ...
 <Text variant="label" as="span" className="ml-auto font-semibold bg-zinc-100 dark:bg-zinc-800 px-2 py-0.5 rounded-full">
 ...
 >
 <Text variant="body" className="font-semibold leading-tight">
 {p.title}
 </Text>
 <div className="flex items-center gap-2 mt-1">
 <span className="text-xs font-semibold uppercase bg-zinc-200/50 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 px-1.5 py-0.5 rounded">
 {p.bucketId || "General"}
 </span>
 {priority.label && (
 <span className={`text-xs font-semibold uppercase px-1.5 py-0.5 rounded-md border flex items-center gap-1 ${priority.classes}`}>
 ...
 <span className="shrink-0 text-xs font-semibold bg-white dark:bg-black/20 px-1.5 py-0.5 rounded-md border border-zinc-200 dark:border-zinc-700">
