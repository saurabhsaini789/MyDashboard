  ...
  const getPriorityInfo = (p: Project) => {
    ...
    if (!p.dueDate) {
      return {
        ...
        color: 'green',
        icon: p.isImportant ? '📌' : '🟢',
        classes: 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20'
      };
    }
    ...
    if (urgency === 'overdue' || urgency === 'soon') {
      ...
      return {
        ...
        icon: '⚠️',
        color: 'red',
        classes: 'bg-rose-50/50 dark:bg-rose-500/5 text-rose-600 dark:text-rose-400/80 border border-rose-100 dark:border-rose-500/10'
      };
    }
