      ...
      {isEditing ? (
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4 p-5 bg-zinc-50 dark:bg-zinc-900/30 rounded-2xl border border-zinc-100 dark:border-zinc-800">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="px-4 py-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg text-xs font-bold text-zinc-700 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-700"
              >
                Edit Project
              </button>
              <button
                ...
                className="px-4 py-2 bg-rose-50 dark:bg-rose-900/10 text-rose-600 dark:text-rose-400 rounded-lg text-xs font-bold hover:bg-rose-100 dark:hover:bg-rose-900/20"
              >
                Delete
              </button>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-sm font-bold uppercase text-zinc-400 tracking-widest flex justify-between">
              Tasks
            ...
            <div className="flex gap-2">
              ...
              />
              <button onClick={handleCreateTask} disabled={!newTaskTitle} type="button" className="px-4 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 rounded-lg text-sm font-bold disabled:opacity-50">Add</button>
            </div>
          </div>
        </div>
      )}
