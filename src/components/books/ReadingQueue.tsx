...
export function ReadingQueue({ onPromote }: ReadingQueueProps) {
 ...
 className="w-full sm:w-auto flex items-center justify-center gap-2 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 px-6 py-2.5 rounded-2xl text-sm font-semibold hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-zinc-900/10 dark:shadow-white/5"
 >
 <Plus size={18} />
 Add Book
 </button>
