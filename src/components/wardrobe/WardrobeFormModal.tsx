...
export function WardrobeFormModal({ isOpen, onClose, onSave, initialData }: WardrobeFormModalProps) {
 ...
 { name: 'purchaseReason', label: 'Purchase Reason', type: 'select', fullWidth: true, options: WARDROBE_PURCHASE_REASONS },
 { name: 'replacementCycle', label: 'Replacement Cycle', type: 'text', fullWidth: true, placeholder: 'e.g., 2 years' },
 ]
 },
 {
 id: 'feedback',
