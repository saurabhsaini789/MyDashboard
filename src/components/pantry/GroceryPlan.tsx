...
export function GroceryPlan({ records, viewingDate }: GroceryPlanProps) {
 ...
 className="px-4 py-2 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-xl text-xs font-semibold uppercase transition-all text-zinc-600 dark:text-zinc-300 shadow-sm"
 >
 ...
 <td colSpan={6} className="px-5 py-3 text-xs font-semibold uppercase text-zinc-600 dark:text-zinc-300">
 {categoryName}
 </td>
 </tr>
 ...
 <td className="p-4">
 <div className="flex flex-col gap-0.5">
 <span className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">{item.plannedQuantity} Ã— {item.unitSize || '1 Unit'}</span>
 ...
 <td className="p-4">
 {isSkipped ? (
 <span className="text-xs font-semibold uppercase bg-zinc-100 dark:bg-zinc-800 px-3 py-1 rounded-lg text-zinc-500">Skipped for {viewingDate.toLocaleString('default', { month: 'short' })}</span>
 ) : (
 <div className="flex flex-wrap gap-1.5 items-center">
 <span className={`text-xs font-semibold w-6 mr-1 ${isExceeded ? 'text-rose-500' : 'text-zinc-400'}`}>
 ...
 className={`w-5 h-5 rounded flex items-center justify-center transition-all ${isBought ? (autoFilled ? 'bg-teal-500 shadow text-white' : 'bg-zinc-800 text-white shadow-sm') : isSkippedUnit ? 'bg-rose-100 dark:bg-rose-900/30 text-rose-500 border border-rose-200 dark:border-rose-800' : 'bg-zinc-100 dark:bg-zinc-800/50 hover:bg-zinc-200 dark:hover:bg-zinc-700 border border-zinc-200/50 dark:border-zinc-700/50'}`}
 >
 ...
 <span className={`text-sm font-semibold ${isSkipped ? 'text-zinc-400 line-through' : 'text-zinc-900 dark:text-white'}`}>
 ...
 className="px-4 py-2 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-900 dark:hover:bg-white hover:text-white dark:hover:text-zinc-900 rounded-xl text-xs font-semibold uppercase transition-all shadow-sm"
 >
 Edit Item
 </button>
 </div>
