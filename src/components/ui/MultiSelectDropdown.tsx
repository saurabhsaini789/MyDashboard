...
export function MultiSelectDropdown({ label, options, selected, onChange }: MultiSelectDropdownProps) {
 ...
 <span className="text-xs font-semibold text-zinc-400 uppercase leading-none mb-1">{label}</span>
 <span className="text-xs font-semibold text-zinc-900 dark:text-zinc-100 uppercase">{displayText}</span>
 </div>
 ...
 >
 <span className="text-xs font-semibold uppercase">{labelStr}</span>
 {isSelected && (
