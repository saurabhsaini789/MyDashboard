...
export const Modal: React.FC<ModalProps> = ({
 ...
 <Text id="modal-title" variant="title" as="h3" className="flex-1">
 {title}
 </Text>
 ...
 type="button"
 onClick={onClose}
 className="px-4 py-2 rounded-xl border border-zinc-300 bg-white hover:bg-zinc-50 dark:bg-zinc-900 dark:border-zinc-800 dark:hover:bg-zinc-800 transition-colors"
 >
 <Text variant="body" as="span" className="font-medium text-zinc-700 dark:text-zinc-300">
 ...
 className={`px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-sm active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 ${buttonColorMap[accentColor] || buttonColorMap.blue}`}
 >
 {submitText}
 </button>
 )}
